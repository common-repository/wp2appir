...
function onetarek_wpmut_admin_scripts() 
{
	 ...
	 {
	 	wp_enqueue_media();
		wp_register_script('upload_setting_page.js', WP_PLUGIN_URL."/".dirname( plugin_basename( __FILE__ ) ).'/../assets/js/upload_setting_page.js', array('jquery'));
...
//--------------------------------------------------------------------------------------------------------------------------
?>
<div class="col-md-12" style="margin-top:5px;z-index:9999;color:black;">

	<div class="col-md-10"></div>
	<div class="col-md-2">
		<button type="button" onclick="set_page_menu(2)" id="active_primery_id" class="btn btn-primary btn-sm">صفحه اصلی</button>
		<button type="button" onclick="set_page_menu(1)" id="active_splash_id" class="btn btn-primary btn-sm">اسپلش</button>
	</div>
</div>
